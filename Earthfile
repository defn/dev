...
coderServer:
    ...
    RUN for a in betterthantomorrow.calva betterthantomorrow.joyride golang.Go astro-build.astro-vscode vscodevim.vim; do /home/ubuntu/.local/bin/code-server --install-extension "$a"; done
    SAVE ARTIFACT .local
