...
awscli:
    ...
    RUN curl -sSL -o aws_signer_helper https://s3.amazonaws.com/roles-anywhere-credential-helper/CredentialHelper/latest/linux_amd64/aws_signing_helper && chmod 755 aws_signer_helper
