...
local_resource(
    ...
    serve_cmd="exec bash -c 'docker exec earthly-buildkitd pkill socat; exec docker exec earthly-buildkitd socat TCP-LISTEN:5555,fork,reuseaddr TCP:$(host host.k3d.internal | cut -d\\  -f4):5555'",
)
