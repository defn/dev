{
  inputs = {
    ...
    kubernetes.url = github:defn/pkg/kubernetes-0.0.13?dir=kubernetes;
    cloud.url = github:defn/pkg/cloud-0.0.9?dir=cloud;
    az.url = github:defn/pkg/az-0.0.28?dir=az;
    ...
    godev.url = github:defn/pkg/godev-0.0.13?dir=godev;
