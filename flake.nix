{
  inputs = {
    ...
    az.url = github:defn/pkg/az-0.0.31?dir=az;
    ...
    localdev.url = github:defn/pkg/localdev-0.0.43?dir=localdev;
    tailscale.url = github:defn/pkg/tailscale-1.36.1-3?dir=tailscale;
