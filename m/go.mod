...
replace (
	// Pin docker/cli and docker/docker to v28.x - v29+ migrated to moby/moby modules
	// which are incompatible with our tilt code that imports github.com/docker/docker
