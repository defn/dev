{
  inputs = {
    godev.url = github:defn/dev/pkg-godev-0.0.88?dir=m/pkg/godev;
    ...
    cloud.url = github:defn/dev/pkg-cloud-0.0.104?dir=m/pkg/cloud;
    kubernetes.url = github:defn/dev/pkg-kubernetes-0.0.107?dir=m/pkg/kubernetes;
