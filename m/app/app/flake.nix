{
  inputs = {
    ...
    cloud.url = github:defn/dev/pkg-cloud-0.0.107?dir=m/pkg/cloud;
    kubernetes.url = github:defn/dev/pkg-kubernetes-0.0.108?dir=m/pkg/kubernetes;
    localdev.url = github:defn/dev/pkg-localdev-0.0.134?dir=m/pkg/localdev;
