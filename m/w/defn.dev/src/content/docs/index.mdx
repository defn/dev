...
hero:
  ...
  actions:
    - text: Change me
      link: https://coder.kowloon.defn.run/templates/coder/coder-defn-k8s-template/workspace?mode=auto&param.homedir=%2Fhome%2Fubuntu%2Fm%2Fw%2Fsites%2Fdefn.dev
      icon: right-arrow
      variant: minimal
---
