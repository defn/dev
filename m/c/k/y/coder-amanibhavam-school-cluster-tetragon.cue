...
res: serviceaccount: "coder-amanibhavam-school-cluster-tetragon": "kube-system": tetragon: {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		labels: {
...
res: serviceaccount: "coder-amanibhavam-school-cluster-tetragon": "kube-system": "tetragon-operator-service-account": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		labels: {
...
res: clusterrole: "coder-amanibhavam-school-cluster-tetragon": cluster: tetragon: {
...
res: clusterrole: "coder-amanibhavam-school-cluster-tetragon": cluster: "tetragon-operator": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: {
...
res: clusterrolebinding: "coder-amanibhavam-school-cluster-tetragon": cluster: tetragon: {
	apiVersion: "rbac.authorization.k8s.io/v1"
...
res: clusterrolebinding: "coder-amanibhavam-school-cluster-tetragon": cluster: "tetragon-operator-rolebinding": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRoleBinding"
	metadata: {
		labels: {
...
res: configmap: "coder-amanibhavam-school-cluster-tetragon": "kube-system": "tetragon-config": {
	apiVersion: "v1"
	data: {
		"enable-k8s-api":       "true"
...
res: configmap: "coder-amanibhavam-school-cluster-tetragon": "kube-system": "tetragon-operator-config": {
	apiVersion: "v1"
	data: {
...
res: service: "coder-amanibhavam-school-cluster-tetragon": "kube-system": tetragon: {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
res: deployment: "coder-amanibhavam-school-cluster-tetragon": "kube-system": "tetragon-operator": {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
...
res: daemonset: "coder-amanibhavam-school-cluster-tetragon": "kube-system": tetragon: {
	apiVersion: "apps/v1"
	kind:       "DaemonSet"
	metadata: {
		labels: {
