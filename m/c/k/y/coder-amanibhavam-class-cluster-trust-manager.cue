...
res: customresourcedefinition: "coder-amanibhavam-class-cluster-trust-manager": cluster: "bundles.trust.cert-manager.io": {
...
res: serviceaccount: "coder-amanibhavam-class-cluster-trust-manager": "cert-manager": "trust-manager": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		labels: {
...
res: role: "coder-amanibhavam-class-cluster-trust-manager": "cert-manager": "trust-manager": {
...
res: clusterrole: "coder-amanibhavam-class-cluster-trust-manager": cluster: "trust-manager": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: {
...
res: rolebinding: "coder-amanibhavam-class-cluster-trust-manager": "cert-manager": "trust-manager": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "RoleBinding"
	metadata: {
		labels: {
...
res: clusterrolebinding: "coder-amanibhavam-class-cluster-trust-manager": cluster: "trust-manager": {
	apiVersion: "rbac.authorization.k8s.io/v1"
...
res: service: "coder-amanibhavam-class-cluster-trust-manager": "cert-manager": "trust-manager": {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
res: service: "coder-amanibhavam-class-cluster-trust-manager": "cert-manager": "trust-manager-metrics": {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
res: deployment: "coder-amanibhavam-class-cluster-trust-manager": "cert-manager": "trust-manager": {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
...
res: certificate: "coder-amanibhavam-class-cluster-trust-manager": "cert-manager": "trust-manager": {
...
res: issuer: "coder-amanibhavam-class-cluster-trust-manager": "cert-manager": "trust-manager": {
	apiVersion: "cert-manager.io/v1"
	kind:       "Issuer"
	metadata: {
		labels: {
...
res: validatingwebhookconfiguration: "coder-amanibhavam-class-cluster-trust-manager": cluster: "trust-manager": {
