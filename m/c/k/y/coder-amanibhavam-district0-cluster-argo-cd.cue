...
res: configmap: "coder-amanibhavam-district0-cluster-argo-cd": argocd: "argocd-cm": {
	...
	data: {
		...
		url: "https://argocd-district0.district.amanibhavam.defn.run"
	}
	kind: "ConfigMap"
	metadata: {
		labels: {
...
res: externalsecret: "coder-amanibhavam-district0-cluster-argo-cd": argocd: "dex-github-oidc": {
	...
	spec: {
		data: [{
			remoteRef: {
				key:      "coder-amanibhavam-district0-cluster"
		...
		secretStoreRef: {
			...
			name: "coder-amanibhavam-district0"
		}
	}
}
