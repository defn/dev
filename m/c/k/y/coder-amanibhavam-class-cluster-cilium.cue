...
res: serviceaccount: "coder-amanibhavam-class-cluster-cilium": "kube-system": cilium: {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		name:      "cilium"
...
res: serviceaccount: "coder-amanibhavam-class-cluster-cilium": "kube-system": "cilium-envoy": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		name:      "cilium-envoy"
...
res: serviceaccount: "coder-amanibhavam-class-cluster-cilium": "kube-system": "cilium-operator": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
...
res: serviceaccount: "coder-amanibhavam-class-cluster-cilium": "kube-system": "clustermesh-apiserver": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
...
res: serviceaccount: "coder-amanibhavam-class-cluster-cilium": "kube-system": "hubble-relay": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		name:      "hubble-relay"
...
res: serviceaccount: "coder-amanibhavam-class-cluster-cilium": "kube-system": "hubble-ui": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		name:      "hubble-ui"
...
res: role: "coder-amanibhavam-class-cluster-cilium": "kube-system": "cilium-config-agent": {
...
res: clusterrole: "coder-amanibhavam-class-cluster-cilium": cluster: cilium: {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: "app.kubernetes.io/part-of": "cilium"
...
res: clusterrole: "coder-amanibhavam-class-cluster-cilium": cluster: "cilium-operator": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: "app.kubernetes.io/part-of": "cilium"
...
res: clusterrole: "coder-amanibhavam-class-cluster-cilium": cluster: "clustermesh-apiserver": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: "app.kubernetes.io/part-of": "cilium"
...
res: clusterrole: "coder-amanibhavam-class-cluster-cilium": cluster: "hubble-ui": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: "app.kubernetes.io/part-of": "cilium"
...
res: rolebinding: "coder-amanibhavam-class-cluster-cilium": "kube-system": "cilium-config-agent": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "RoleBinding"
	metadata: {
		labels: "app.kubernetes.io/part-of": "cilium"
...
res: clusterrolebinding: "coder-amanibhavam-class-cluster-cilium": cluster: cilium: {
	apiVersion: "rbac.authorization.k8s.io/v1"
...
res: clusterrolebinding: "coder-amanibhavam-class-cluster-cilium": cluster: "cilium-operator": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRoleBinding"
	metadata: {
		labels: "app.kubernetes.io/part-of": "cilium"
...
res: clusterrolebinding: "coder-amanibhavam-class-cluster-cilium": cluster: "clustermesh-apiserver": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRoleBinding"
	metadata: {
		labels: "app.kubernetes.io/part-of": "cilium"
...
res: clusterrolebinding: "coder-amanibhavam-class-cluster-cilium": cluster: "hubble-ui": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRoleBinding"
	metadata: {
		labels: "app.kubernetes.io/part-of": "cilium"
...
res: configmap: "coder-amanibhavam-class-cluster-cilium": "kube-system": "cilium-config": {
	apiVersion: "v1"
	data: {
		...
		"cluster-pool-ipv4-cidr":                         "10.201.0.0/17"
...
res: configmap: "coder-amanibhavam-class-cluster-cilium": "kube-system": "cilium-envoy-config": {
	apiVersion: "v1"
...
res: configmap: "coder-amanibhavam-class-cluster-cilium": "kube-system": "hubble-relay-config": {
	apiVersion: "v1"
	data: "config.yaml": """
		cluster-name: coder-amanibhavam-class
...
res: configmap: "coder-amanibhavam-class-cluster-cilium": "kube-system": "hubble-ui-nginx": {
	apiVersion: "v1"
	data: "nginx.conf": """
		server {
		    listen       8081;
...
res: service: "coder-amanibhavam-class-cluster-cilium": "kube-system": "cilium-envoy": {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		annotations: {
...
res: service: "coder-amanibhavam-class-cluster-cilium": "kube-system": "clustermesh-apiserver": {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
res: service: "coder-amanibhavam-class-cluster-cilium": "kube-system": "clustermesh-apiserver-metrics": {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
res: service: "coder-amanibhavam-class-cluster-cilium": "kube-system": "hubble-peer": {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
res: service: "coder-amanibhavam-class-cluster-cilium": "kube-system": "hubble-relay": {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
res: service: "coder-amanibhavam-class-cluster-cilium": "kube-system": "hubble-ui": {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
res: deployment: "coder-amanibhavam-class-cluster-cilium": "kube-system": "cilium-operator": {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
...
res: deployment: "coder-amanibhavam-class-cluster-cilium": "kube-system": "clustermesh-apiserver": {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
...
res: deployment: "coder-amanibhavam-class-cluster-cilium": "kube-system": "hubble-relay": {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
...
res: deployment: "coder-amanibhavam-class-cluster-cilium": "kube-system": "hubble-ui": {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
...
res: daemonset: "coder-amanibhavam-class-cluster-cilium": "kube-system": cilium: {
	apiVersion: "apps/v1"
	kind:       "DaemonSet"
	metadata: {
		labels: {
...
res: daemonset: "coder-amanibhavam-class-cluster-cilium": "kube-system": "cilium-envoy": {
	apiVersion: "apps/v1"
	kind:       "DaemonSet"
	metadata: {
		labels: {
...
res: certificate: "coder-amanibhavam-class-cluster-cilium": "kube-system": "clustermesh-apiserver-admin-cert": {
	...
	spec: {
		commonName: "admin-coder-amanibhavam-class"
		dnsNames: ["localhost"]
		duration: "26280h0m0s"
		issuerRef: {
...
res: certificate: "coder-amanibhavam-class-cluster-cilium": "kube-system": "clustermesh-apiserver-remote-cert": {
	apiVersion: "cert-manager.io/v1"
	kind:       "Certificate"
	metadata: {
		name:      "clustermesh-apiserver-remote-cert"
...
res: certificate: "coder-amanibhavam-class-cluster-cilium": "kube-system": "clustermesh-apiserver-server-cert": {
	apiVersion: "cert-manager.io/v1"
	kind:       "Certificate"
	metadata: {
		name:      "clustermesh-apiserver-server-cert"
...
res: certificate: "coder-amanibhavam-class-cluster-cilium": "kube-system": "hubble-relay-client-certs": {
	apiVersion: "cert-manager.io/v1"
	kind:       "Certificate"
	metadata: {
		name:      "hubble-relay-client-certs"
...
res: certificate: "coder-amanibhavam-class-cluster-cilium": "kube-system": "hubble-server-certs": {
	apiVersion: "cert-manager.io/v1"
	kind:       "Certificate"
	metadata: {
		name:      "hubble-server-certs"
	...
	spec: {
		...
		dnsNames: ["*.coder-amanibhavam-class.hubble-grpc.cilium.io"]
		duration: "26280h0m0s"
		issuerRef: {
			group: "cert-manager.io"
			kind:  "ClusterIssuer"
...
res: ingress: "coder-amanibhavam-class-cluster-cilium": "kube-system": "hubble-ui": {
