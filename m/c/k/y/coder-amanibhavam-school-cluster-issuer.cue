...
res: externalsecret: "coder-amanibhavam-school-cluster-issuer": "cert-manager": "letsencrypt-production": {
...
res: externalsecret: "coder-amanibhavam-school-cluster-issuer": "cert-manager": "letsencrypt-staging": {
	apiVersion: "external-secrets.io/v1beta1"
	kind:       "ExternalSecret"
	metadata: {
...
res: externalsecret: "coder-amanibhavam-school-cluster-issuer": "cert-manager": "zerossl-production": {
	apiVersion: "external-secrets.io/v1beta1"
	kind:       "ExternalSecret"
	metadata: {
...
res: clusterpolicy: "coder-amanibhavam-school-cluster-issuer": cluster: "letsencrypt-production-clusterissuer": {
...
res: clusterpolicy: "coder-amanibhavam-school-cluster-issuer": cluster: "letsencrypt-staging-clusterissuer": {
	apiVersion: "kyverno.io/v1"
	kind:       "ClusterPolicy"
...
res: clusterpolicy: "coder-amanibhavam-school-cluster-issuer": cluster: "zerossl-production-clusterissuer": {
	apiVersion: "kyverno.io/v1"
	kind:       "ClusterPolicy"
