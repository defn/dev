...
res: namespace: "coder-amanibhavam-district-cluster-postgres-operator": cluster: "postgres-operator": {
	apiVersion: "v1"
	kind:       "Namespace"
	metadata: name: "postgres-operator"
}
res: customresourcedefinition: "coder-amanibhavam-district-cluster-postgres-operator": cluster: "operatorconfigurations.acid.zalan.do": {
...
res: customresourcedefinition: "coder-amanibhavam-district-cluster-postgres-operator": cluster: "postgresqls.acid.zalan.do": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		labels: "app.kubernetes.io/name": "postgres-operator"
...
res: customresourcedefinition: "coder-amanibhavam-district-cluster-postgres-operator": cluster: "postgresteams.acid.zalan.do": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		labels: "app.kubernetes.io/name": "postgres-operator"
...
res: serviceaccount: "coder-amanibhavam-district-cluster-postgres-operator": "postgres-operator": "postgres-operator": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		labels: {
...
res: clusterrole: "coder-amanibhavam-district-cluster-postgres-operator": cluster: "postgres-operator": {
...
res: clusterrole: "coder-amanibhavam-district-cluster-postgres-operator": cluster: "postgres-pod": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: {
...
res: clusterrolebinding: "coder-amanibhavam-district-cluster-postgres-operator": cluster: "postgres-operator": {
	apiVersion: "rbac.authorization.k8s.io/v1"
...
res: service: "coder-amanibhavam-district-cluster-postgres-operator": "postgres-operator": "postgres-operator": {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
res: deployment: "coder-amanibhavam-district-cluster-postgres-operator": "postgres-operator": "postgres-operator": {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
...
res: operatorconfiguration: "coder-amanibhavam-district-cluster-postgres-operator": "postgres-operator": "postgres-operator": {
