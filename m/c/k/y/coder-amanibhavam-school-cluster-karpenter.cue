...
res: namespace: "coder-amanibhavam-school-cluster-karpenter": cluster: karpenter: {
	apiVersion: "v1"
	kind:       "Namespace"
	metadata: name: "karpenter"
}
res: customresourcedefinition: "coder-amanibhavam-school-cluster-karpenter": cluster: "awsnodetemplates.karpenter.k8s.aws": {
...
res: customresourcedefinition: "coder-amanibhavam-school-cluster-karpenter": cluster: "ec2nodeclasses.karpenter.k8s.aws": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.13.0"
...
res: customresourcedefinition: "coder-amanibhavam-school-cluster-karpenter": cluster: "machines.karpenter.sh": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.13.0"
...
res: customresourcedefinition: "coder-amanibhavam-school-cluster-karpenter": cluster: "nodeclaims.karpenter.sh": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.13.0"
...
res: customresourcedefinition: "coder-amanibhavam-school-cluster-karpenter": cluster: "nodepools.karpenter.sh": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.13.0"
...
res: customresourcedefinition: "coder-amanibhavam-school-cluster-karpenter": cluster: "provisioners.karpenter.sh": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.13.0"
...
res: serviceaccount: "coder-amanibhavam-school-cluster-karpenter": karpenter: karpenter: {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		annotations: "eks.amazonaws.com/role-arn": "arn:aws:iam::510430971399:role/coder-amanibhavam-school-cluster"
		labels: {
...
res: role: "coder-amanibhavam-school-cluster-karpenter": karpenter: karpenter: {
...
res: role: "coder-amanibhavam-school-cluster-karpenter": karpenter: "karpenter-dns": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "Role"
	metadata: {
		labels: {
...
res: role: "coder-amanibhavam-school-cluster-karpenter": karpenter: "karpenter-lease": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "Role"
	metadata: {
		labels: {
...
res: clusterrole: "coder-amanibhavam-school-cluster-karpenter": cluster: karpenter: {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: {
...
res: clusterrole: "coder-amanibhavam-school-cluster-karpenter": cluster: "karpenter-admin": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: {
...
res: clusterrole: "coder-amanibhavam-school-cluster-karpenter": cluster: "karpenter-core": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: {
...
res: rolebinding: "coder-amanibhavam-school-cluster-karpenter": karpenter: karpenter: {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "RoleBinding"
	metadata: {
		labels: {
...
res: rolebinding: "coder-amanibhavam-school-cluster-karpenter": karpenter: "karpenter-dns": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "RoleBinding"
	metadata: {
		labels: {
...
res: rolebinding: "coder-amanibhavam-school-cluster-karpenter": karpenter: "karpenter-lease": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "RoleBinding"
	metadata: {
		labels: {
...
res: clusterrolebinding: "coder-amanibhavam-school-cluster-karpenter": cluster: karpenter: {
	apiVersion: "rbac.authorization.k8s.io/v1"
...
res: clusterrolebinding: "coder-amanibhavam-school-cluster-karpenter": cluster: "karpenter-admin": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRoleBinding"
...
res: clusterrolebinding: "coder-amanibhavam-school-cluster-karpenter": cluster: "karpenter-boot-strapper": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRoleBinding"
...
res: clusterrolebinding: "coder-amanibhavam-school-cluster-karpenter": cluster: "karpenter-core": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRoleBinding"
	metadata: {
		labels: {
...
res: clusterrolebinding: "coder-amanibhavam-school-cluster-karpenter": cluster: "karpenter-node": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRoleBinding"
...
res: configmap: "coder-amanibhavam-school-cluster-karpenter": karpenter: "config-logging": {
	apiVersion: "v1"
	data: {
...
res: configmap: "coder-amanibhavam-school-cluster-karpenter": karpenter: "karpenter-global-settings": {
	apiVersion: "v1"
	data: {
		"aws.clusterEndpoint": "https://kubernetes.default.svc.cluster.local:443"
		"aws.clusterName":     "coder-amanibhavam-school"
...
res: secret: "coder-amanibhavam-school-cluster-karpenter": karpenter: "karpenter-cert": {
	apiVersion: "v1"
	kind:       "Secret"
	metadata: {
		labels: {
...
res: service: "coder-amanibhavam-school-cluster-karpenter": karpenter: karpenter: {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
res: deployment: "coder-amanibhavam-school-cluster-karpenter": karpenter: karpenter: {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
...
res: poddisruptionbudget: "coder-amanibhavam-school-cluster-karpenter": karpenter: karpenter: {
...
res: awsnodetemplate: "coder-amanibhavam-school-cluster-karpenter": karpenter: default: {
	...
	spec: {
		amiFamily: "Custom"
		amiSelector: "karpenter.sh/discovery": "coder-amanibhavam-school"
		blockDeviceMappings: [{
			deviceName: "/dev/sda1"
			ebs: {
		...
		instanceProfile: "coder-amanibhavam-school"
		securityGroupSelector: "karpenter.sh/discovery": "coder-amanibhavam-school"
		subnetSelector: "karpenter.sh/discovery": "coder-amanibhavam-school"
		userData: """
			MIME-Version: 1.0
			...
			cluster_name=coder-amanibhavam-school
...
res: provisioner: "coder-amanibhavam-school-cluster-karpenter": karpenter: default: {
...
res: mutatingwebhookconfiguration: "coder-amanibhavam-school-cluster-karpenter": cluster: "defaulting.webhook.karpenter.k8s.aws": {
...
res: validatingwebhookconfiguration: "coder-amanibhavam-school-cluster-karpenter": cluster: "validation.webhook.config.karpenter.sh": {
	apiVersion: "admissionregistration.k8s.io/v1"
...
res: validatingwebhookconfiguration: "coder-amanibhavam-school-cluster-karpenter": cluster: "validation.webhook.karpenter.k8s.aws": {
	apiVersion: "admissionregistration.k8s.io/v1"
	kind:       "ValidatingWebhookConfiguration"
	metadata: {
		labels: {
...
res: validatingwebhookconfiguration: "coder-amanibhavam-school-cluster-karpenter": cluster: "validation.webhook.karpenter.sh": {
	apiVersion: "admissionregistration.k8s.io/v1"
	kind:       "ValidatingWebhookConfiguration"
	metadata: {
		labels: {
