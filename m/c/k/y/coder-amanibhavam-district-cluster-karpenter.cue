...
res: namespace: "coder-amanibhavam-district-cluster-karpenter": cluster: karpenter: {
	apiVersion: "v1"
	kind:       "Namespace"
	metadata: name: "karpenter"
}
res: customresourcedefinition: "coder-amanibhavam-district-cluster-karpenter": cluster: "awsnodetemplates.karpenter.k8s.aws": {
...
res: customresourcedefinition: "coder-amanibhavam-district-cluster-karpenter": cluster: "ec2nodeclasses.karpenter.k8s.aws": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.13.0"
...
res: customresourcedefinition: "coder-amanibhavam-district-cluster-karpenter": cluster: "machines.karpenter.sh": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.13.0"
...
res: customresourcedefinition: "coder-amanibhavam-district-cluster-karpenter": cluster: "nodeclaims.karpenter.sh": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.13.0"
...
res: customresourcedefinition: "coder-amanibhavam-district-cluster-karpenter": cluster: "nodepools.karpenter.sh": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.13.0"
...
res: customresourcedefinition: "coder-amanibhavam-district-cluster-karpenter": cluster: "provisioners.karpenter.sh": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.13.0"
...
res: serviceaccount: "coder-amanibhavam-district-cluster-karpenter": karpenter: karpenter: {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		annotations: "eks.amazonaws.com/role-arn": "arn:aws:iam::510430971399:role/coder-amanibhavam-district-cluster"
		labels: {
...
res: role: "coder-amanibhavam-district-cluster-karpenter": karpenter: karpenter: {
...
res: role: "coder-amanibhavam-district-cluster-karpenter": karpenter: "karpenter-dns": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "Role"
	metadata: {
		labels: {
...
res: role: "coder-amanibhavam-district-cluster-karpenter": karpenter: "karpenter-lease": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "Role"
	metadata: {
		labels: {
...
res: clusterrole: "coder-amanibhavam-district-cluster-karpenter": cluster: karpenter: {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: {
...
res: clusterrole: "coder-amanibhavam-district-cluster-karpenter": cluster: "karpenter-admin": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: {
...
res: clusterrole: "coder-amanibhavam-district-cluster-karpenter": cluster: "karpenter-core": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: {
...
res: rolebinding: "coder-amanibhavam-district-cluster-karpenter": karpenter: karpenter: {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "RoleBinding"
	metadata: {
		labels: {
...
res: rolebinding: "coder-amanibhavam-district-cluster-karpenter": karpenter: "karpenter-dns": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "RoleBinding"
	metadata: {
		labels: {
...
res: rolebinding: "coder-amanibhavam-district-cluster-karpenter": karpenter: "karpenter-lease": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "RoleBinding"
	metadata: {
		labels: {
...
res: clusterrolebinding: "coder-amanibhavam-district-cluster-karpenter": cluster: karpenter: {
	apiVersion: "rbac.authorization.k8s.io/v1"
...
res: clusterrolebinding: "coder-amanibhavam-district-cluster-karpenter": cluster: "karpenter-admin": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRoleBinding"
...
res: clusterrolebinding: "coder-amanibhavam-district-cluster-karpenter": cluster: "karpenter-boot-strapper": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRoleBinding"
...
res: clusterrolebinding: "coder-amanibhavam-district-cluster-karpenter": cluster: "karpenter-core": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRoleBinding"
	metadata: {
		labels: {
...
res: clusterrolebinding: "coder-amanibhavam-district-cluster-karpenter": cluster: "karpenter-node": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRoleBinding"
...
res: configmap: "coder-amanibhavam-district-cluster-karpenter": karpenter: "config-logging": {
	apiVersion: "v1"
	data: {
...
res: configmap: "coder-amanibhavam-district-cluster-karpenter": karpenter: "karpenter-global-settings": {
	apiVersion: "v1"
	data: {
		"aws.clusterEndpoint": "https://kubernetes.default.svc.cluster.local:443"
		"aws.clusterName":     "coder-amanibhavam-district"
...
res: secret: "coder-amanibhavam-district-cluster-karpenter": karpenter: "karpenter-cert": {
	apiVersion: "v1"
	kind:       "Secret"
	metadata: {
		labels: {
...
res: service: "coder-amanibhavam-district-cluster-karpenter": karpenter: karpenter: {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
res: deployment: "coder-amanibhavam-district-cluster-karpenter": karpenter: karpenter: {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
...
res: poddisruptionbudget: "coder-amanibhavam-district-cluster-karpenter": karpenter: karpenter: {
...
res: awsnodetemplate: "coder-amanibhavam-district-cluster-karpenter": karpenter: default: {
	...
	spec: {
		amiFamily: "Custom"
		amiSelector: "karpenter.sh/discovery": "coder-amanibhavam-district"
		blockDeviceMappings: [{
			deviceName: "/dev/sda1"
			ebs: {
		...
		instanceProfile: "coder-amanibhavam-district"
		securityGroupSelector: "karpenter.sh/discovery": "coder-amanibhavam-district"
		subnetSelector: "karpenter.sh/discovery": "coder-amanibhavam-district"
		userData: """
			MIME-Version: 1.0
			...
			cluster_name=coder-amanibhavam-district
...
res: provisioner: "coder-amanibhavam-district-cluster-karpenter": karpenter: default: {
...
res: mutatingwebhookconfiguration: "coder-amanibhavam-district-cluster-karpenter": cluster: "defaulting.webhook.karpenter.k8s.aws": {
...
res: validatingwebhookconfiguration: "coder-amanibhavam-district-cluster-karpenter": cluster: "validation.webhook.config.karpenter.sh": {
	apiVersion: "admissionregistration.k8s.io/v1"
...
res: validatingwebhookconfiguration: "coder-amanibhavam-district-cluster-karpenter": cluster: "validation.webhook.karpenter.k8s.aws": {
	apiVersion: "admissionregistration.k8s.io/v1"
	kind:       "ValidatingWebhookConfiguration"
	metadata: {
		labels: {
...
res: validatingwebhookconfiguration: "coder-amanibhavam-district-cluster-karpenter": cluster: "validation.webhook.karpenter.sh": {
	apiVersion: "admissionregistration.k8s.io/v1"
	kind:       "ValidatingWebhookConfiguration"
	metadata: {
		labels: {
