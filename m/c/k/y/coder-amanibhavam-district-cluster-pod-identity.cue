...
res: serviceaccount: "coder-amanibhavam-district-cluster-pod-identity": "kube-system": "pod-identity-amazon-eks-pod-identity-webhook": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		labels: {
...
res: clusterrole: "coder-amanibhavam-district-cluster-pod-identity": cluster: "pod-identity-amazon-eks-pod-identity-webhook": {
...
res: clusterrolebinding: "coder-amanibhavam-district-cluster-pod-identity": cluster: "pod-identity-amazon-eks-pod-identity-webhook": {
	apiVersion: "rbac.authorization.k8s.io/v1"
...
res: service: "coder-amanibhavam-district-cluster-pod-identity": "kube-system": "pod-identity-amazon-eks-pod-identity-webhook": {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
res: deployment: "coder-amanibhavam-district-cluster-pod-identity": "kube-system": "pod-identity-amazon-eks-pod-identity-webhook": {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
...
res: certificate: "coder-amanibhavam-district-cluster-pod-identity": "kube-system": "pod-identity-amazon-eks-pod-identity-webhook": {
...
res: issuer: "coder-amanibhavam-district-cluster-pod-identity": "kube-system": "pod-identity-amazon-eks-pod-identity-webhook": {
	apiVersion: "cert-manager.io/v1"
	kind:       "Issuer"
	metadata: {
		labels: {
...
res: mutatingwebhookconfiguration: "coder-amanibhavam-district-cluster-pod-identity": cluster: "pod-identity-amazon-eks-pod-identity-webhook": {
