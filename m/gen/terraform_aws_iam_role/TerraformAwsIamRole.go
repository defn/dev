...
import (
	...
	_init_ "github.com/defn/dev/m/gen/terraform_aws_iam_role/jsii"

	"github.com/aws/constructs-go/constructs/v10"
	"github.com/defn/dev/m/gen/terraform_aws_iam_role/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Defines an TerraformAwsIamRole based on a Terraform module.
//
// Source at ./tf/mod/terraform-aws-iam-role
