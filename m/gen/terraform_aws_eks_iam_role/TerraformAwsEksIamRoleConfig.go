...
type TerraformAwsEksIamRoleConfig struct {
	// Experimental.
	...
	EksClusterOidcIssuerUrl *string `field:"required" json:"eksClusterOidcIssuerUrl" yaml:"eksClusterOidcIssuerUrl"`
	...
	//
	// If an AWS account number is not provided, the current aws provider account number will be used.
	AwsAccountNumber *string `field:"optional" json:"awsAccountNumber" yaml:"awsAccountNumber"`
	...
	AwsIamPolicyDocument interface{} `field:"optional" json:"awsIamPolicyDocument" yaml:"awsIamPolicyDocument"`
	...
	ServiceAccountListQualifier *string `field:"optional" json:"serviceAccountListQualifier" yaml:"serviceAccountListQualifier"`
	// Kubernetes ServiceAccount name.
	ServiceAccountName *string `field:"optional" json:"serviceAccountName" yaml:"serviceAccountName"`
	// Kubernetes Namespace where service account is deployed.
	ServiceAccountNamespace *string `field:"optional" json:"serviceAccountNamespace" yaml:"serviceAccountNamespace"`
	// List of `namespace:name` for service account assume role IAM policy.
	ServiceAccountNamespaceNameList *[]*string `field:"optional" json:"serviceAccountNamespaceNameList" yaml:"serviceAccountNamespaceNameList"`
	// ID element.
	//
