...
import (
	...
	v1 "github.com/defn/dev/m/defn/dev/demo/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PetStoreServiceName = "defn.dev.demo.v1.PetStoreService"
)
...
const (
	...
	PetStoreServiceGetPetProcedure = "/defn.dev.demo.v1.PetStoreService/GetPet"
	// PetStoreServicePutPetProcedure is the fully-qualified name of the PetStoreService's PutPet RPC.
	PetStoreServicePutPetProcedure = "/defn.dev.demo.v1.PetStoreService/PutPet"
	// PetStoreServiceDeletePetProcedure is the fully-qualified name of the PetStoreService's DeletePet
	// RPC.
	PetStoreServiceDeletePetProcedure = "/defn.dev.demo.v1.PetStoreService/DeletePet"
)

// PetStoreServiceClient is a client for the defn.dev.demo.v1.PetStoreService service.
...
// NewPetStoreServiceClient constructs a client for the defn.dev.demo.v1.PetStoreService service. By
...
// GetPet calls defn.dev.demo.v1.PetStoreService.GetPet.
...
// PutPet calls defn.dev.demo.v1.PetStoreService.PutPet.
...
// DeletePet calls defn.dev.demo.v1.PetStoreService.DeletePet.
...
// PetStoreServiceHandler is an implementation of the defn.dev.demo.v1.PetStoreService service.
...
func (UnimplementedPetStoreServiceHandler) GetPet(context.Context, *connect_go.Request[v1.GetPetRequest]) (*connect_go.Response[v1.GetPetResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("defn.dev.demo.v1.PetStoreService.GetPet is not implemented"))
}
...
func (UnimplementedPetStoreServiceHandler) PutPet(context.Context, *connect_go.Request[v1.PutPetRequest]) (*connect_go.Response[v1.PutPetResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("defn.dev.demo.v1.PetStoreService.PutPet is not implemented"))
}
...
func (UnimplementedPetStoreServiceHandler) DeletePet(context.Context, *connect_go.Request[v1.DeletePetRequest]) (*connect_go.Response[v1.DeletePetResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("defn.dev.demo.v1.PetStoreService.DeletePet is not implemented"))
}
