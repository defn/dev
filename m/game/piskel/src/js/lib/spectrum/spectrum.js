...
(function (window, $, undefined) {
  ...
  function spectrum(element, o) {
    ...
    function show() {
      ...
      if (
        callbacks.beforeShow(colorOnShow) === false ||
    ...
    function onMousedown(e) {
      ...
      var isClickOutsideWidget =
        !parents.is(container) && !target.is(container);
    ...
    function updateUI() {
      ...
      if (opts.showInput) {
        var displayFormat = pskl.UserSettings.get(
          pskl.UserSettings.COLOR_FORMAT,
        );
    ...
    function updateHelperLocations() {
      ...
      dragX = Math.max(
        -dragHelperHeight / 2,
        Math.min(
          dragWidth - dragHelperHeight / 2,
          dragX - dragHelperHeight / 2,
        ),
      );
      dragY = Math.max(
        -dragHelperHeight / 2,
        Math.min(
          dragHeight - dragHelperHeight / 2,
          dragY - dragHelperHeight / 2,
        ),
      );
      dragHelper.css({
        top: dragY,
