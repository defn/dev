(function () {
   ...
   */
  ns.ImageUploadService.prototype.upload = function (
    imageData,
    success,
    error,
  ) {
    ...
    var wrappedSuccess = function (response) {
      var getUrl = pskl.utils.Template.replace(
        Constants.IMAGE_SERVICE_GET_URL,
        {
          protocol: protocol,
        },
      );
    ...
    var uploadUrl = pskl.utils.Template.replace(
      Constants.IMAGE_SERVICE_UPLOAD_URL,
      {
        protocol: protocol,
      },
    );
