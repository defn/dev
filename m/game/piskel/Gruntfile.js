module.exports = function (grunt) {
  ...
  var integrationTestPaths =
    require("./test/casperjs/integration/IntegrationSuite.js").tests;
  var integrationTests = prefixPaths(
    integrationTestPaths,
    "test/casperjs/integration/",
  );
  ...
  // Run drawing tests
  grunt.registerTask("drawing-test", [
    "build-dev",
    "connect:test",
    "casperjs:drawing",
  ]);
