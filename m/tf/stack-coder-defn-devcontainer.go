...
func CoderDefnDevContainerStack(scope constructs.Construct, site *infra.AwsProps, name string) cdktf.TerraformStack {
	stack := cdktf.NewTerraformStack(scope, infra.Js(fmt.Sprintf("coder-defn-devcontainer-%s", name)))
