...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCoderWorkspace)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ownerSessionToken", GoGetter: "OwnerSessionToken"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "startCount", GoGetter: "StartCount"},
	...
	_jsii_.RegisterStruct(
		"coder.dataCoderWorkspace.DataCoderWorkspaceConfig",
		reflect.TypeOf((*DataCoderWorkspaceConfig)(nil)).Elem(),
	)
}
