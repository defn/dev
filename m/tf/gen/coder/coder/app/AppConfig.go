...
type AppConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/resources/app#agent_id App#agent_id}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/resources/app#slug App#slug}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/resources/app#command App#command}
	Command *string `field:"optional" json:"command" yaml:"command"`
	// A display name to identify the app. Defaults to the slug.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/resources/app#display_name App#display_name}
	DisplayName *string `field:"optional" json:"displayName" yaml:"displayName"`
	// Specifies whether "url" is opened on the client machine instead of proxied through the workspace.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/resources/app#external App#external}
	External interface{} `field:"optional" json:"external" yaml:"external"`
	// healthcheck block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/resources/app#healthcheck App#healthcheck}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/resources/app#icon App#icon}
	Icon *string `field:"optional" json:"icon" yaml:"icon"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/resources/app#id App#id}.
	//
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/resources/app#name App#name}
	Name *string `field:"optional" json:"name" yaml:"name"`
	// The order determines the position of app in the UI presentation.
	//
	// The lowest order is shown first and apps with equal order are sorted by name (ascending order).
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/resources/app#order App#order}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/resources/app#relative_path App#relative_path}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/resources/app#share App#share}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/resources/app#subdomain App#subdomain}
	Subdomain interface{} `field:"optional" json:"subdomain" yaml:"subdomain"`
	// An external url if "external=true" or a URL to be proxied to from inside the workspace.
	//
