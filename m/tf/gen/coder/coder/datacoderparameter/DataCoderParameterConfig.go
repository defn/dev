...
type DataCoderParameterConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/data-sources/parameter#name DataCoderParameter#name}
	Name *string `field:"required" json:"name" yaml:"name"`
	// A default value for the parameter.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/data-sources/parameter#default DataCoderParameter#default}
	Default *string `field:"optional" json:"default" yaml:"default"`
	// Describe what this parameter does.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/data-sources/parameter#description DataCoderParameter#description}
	Description *string `field:"optional" json:"description" yaml:"description"`
	// The displayed name of the parameter as it will appear in the interface.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/data-sources/parameter#display_name DataCoderParameter#display_name}
	DisplayName *string `field:"optional" json:"displayName" yaml:"displayName"`
	// The value of an ephemeral parameter will not be preserved between consecutive workspace builds.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/data-sources/parameter#ephemeral DataCoderParameter#ephemeral}
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/data-sources/parameter#id DataCoderParameter#id}.
	//
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/data-sources/parameter#mutable DataCoderParameter#mutable}
	Mutable interface{} `field:"optional" json:"mutable" yaml:"mutable"`
	// option block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/data-sources/parameter#option DataCoderParameter#option}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/data-sources/parameter#order DataCoderParameter#order}
	Order *float64 `field:"optional" json:"order" yaml:"order"`
	// The type of this parameter. Must be one of: "number", "string", "bool", or "list(string)".
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/0.21.0/docs/data-sources/parameter#type DataCoderParameter#type}
