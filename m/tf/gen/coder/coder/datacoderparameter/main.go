...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCoderParameter)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"coder.dataCoderParameter.DataCoderParameterConfig",
		reflect.TypeOf((*DataCoderParameterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"coder.dataCoderParameter.DataCoderParameterOption",
		reflect.TypeOf((*DataCoderParameterOption)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"coder.dataCoderParameter.DataCoderParameterOptionList",
		reflect.TypeOf((*DataCoderParameterOptionList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCoderParameterOptionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"coder.dataCoderParameter.DataCoderParameterValidation",
		reflect.TypeOf((*DataCoderParameterValidation)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"coder.dataCoderParameter.DataCoderParameterValidationOutputReference",
		reflect.TypeOf((*DataCoderParameterValidationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "maxDisabled", GoGetter: "MaxDisabled"},
			_jsii_.MemberProperty{JsiiProperty: "maxInput", GoGetter: "MaxInput"},
			_jsii_.MemberProperty{JsiiProperty: "min", GoGetter: "Min"},
			_jsii_.MemberProperty{JsiiProperty: "minDisabled", GoGetter: "MinDisabled"},
			_jsii_.MemberProperty{JsiiProperty: "minInput", GoGetter: "MinInput"},
			_jsii_.MemberProperty{JsiiProperty: "monotonic", GoGetter: "Monotonic"},
			_jsii_.MemberProperty{JsiiProperty: "monotonicInput", GoGetter: "MonotonicInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMonotonic", GoMethod: "ResetMonotonic"},
