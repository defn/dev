...
type TerraformAwsS3BucketConfig struct {
	...
	//
	// Empty list for no logging, list of 1 to enable logging.
	...
	// List of IP addresses to allow to perform all actions to the bucket.
	SourceIpAllowList *[]*string `field:"optional" json:"sourceIpAllowList" yaml:"sourceIpAllowList"`
