...
import (
	...
	"github.com/defn/dev/m/infra/gen/coder/coder/env/internal"
...
func (j *jsiiProxy_Env) AgentId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"agentId",
...
func (j *jsiiProxy_Env) AgentIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"agentIdInput",
...
func (j *jsiiProxy_Env) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Env) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Env) Value() *string {
	var returns *string
	_jsii_.Get(
		j,
		"value",
...
func (j *jsiiProxy_Env) ValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"valueInput",
...
func (e *jsiiProxy_Env) ResetValue() {
	_jsii_.InvokeVoid(
		e,
		"resetValue",
		nil, // no parameters
