...
cp $TEMP_DIR/go/src/github.com/defn/dev/m/tilt/pkg/webview/log.pb.go pkg/webview/

cp $TEMP_DIR/go/src/github.com/defn/dev/m/tilt/pkg/webview/view.pb.go pkg/webview/

cp $TEMP_DIR/go/src/github.com/defn/dev/m/tilt/pkg/webview/view_grpc.pb.go pkg/webview/

cp $TEMP_DIR/go/src/github.com/defn/dev/m/tilt/pkg/webview/view.swagger.json pkg/webview/
...
cp $TEMP_DIR/go/src/github.com/defn/dev/m/tilt/web/src/view.d.ts web/src/
