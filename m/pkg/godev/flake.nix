{
  inputs = {
    buf.url = github:defn/dev/pkg-buf-1.34.0-1?dir=m/pkg/buf;
    cosign.url = github:defn/dev/pkg-cosign-2.2.4-2?dir=m/pkg/cosign;
    goreleaser.url = github:defn/dev/pkg-goreleaser-2.0.1-2?dir=m/pkg/goreleaser;
