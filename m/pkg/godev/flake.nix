{
  inputs = {
    buf.url = github:defn/dev/pkg-buf-1.28.1-2?dir=m/pkg/buf;
    cosign.url = github:defn/dev/pkg-cosign-2.2.2-2?dir=m/pkg/cosign;
    goreleaser.url = github:defn/dev/pkg-goreleaser-1.22.1-2?dir=m/pkg/goreleaser;
