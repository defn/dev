{
  inputs = {
    buf.url = github:defn/dev/pkg-buf-1.19.0-2?dir=m/pkg/buf;
    cosign.url = github:defn/dev/pkg-cosign-2.0.2-3?dir=m/pkg/cosign;
    goreleaser.url = github:defn/dev/pkg-goreleaser-1.18.2-2?dir=m/pkg/goreleaser;
