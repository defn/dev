...
function main {
	...
	done | (grep -E -v 'vhs/ 0.6.0 0.7.0|coder-compat/|linkerd/ 2.14.[0-9]+ 2.1[23]|argocd/ 2.8.3 2.[567]|linkerd/ 2.14.[0-9] 23|terraform/ 1.5.7 1.[34]|helm/ 3.12.3 3.13.0|argoworkflows/ 3.5.0 3.4|kn/ 1.12.0 1.11|cloudflared/ 2023.8.2 2023.10.0|vcluster/ 0.17.1 0.17.0 ' || true)
}
