...
function main {
	...
	done | (grep -E -v 'kustomize/ 5.3.0 5.4.1|ibazel/ 0.25.0 V0.25.1|argocd/ 2.10.[0-9]+ 2.[89]|coder-compat/|argoworkflows/ 3.5.[0-9]+ 3.4|crossplane/ 1.15.[0-9]+ 1.1[34]|coredns/ 1.11.2 1.11.1' || true)
}
