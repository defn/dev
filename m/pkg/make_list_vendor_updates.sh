...
function main {
	...
	done | (grep -E -v 'kustomize/ 5.0.3 5.1|coder-compat/|tailscale/ 1.46.1 1.48.0|tfo/ 2.0.0-beta2 1.3.0|coder/ 2.1.0 2.1.1|argocd/ 2.8.1 2.7.12|argocd/ 2.8.1 2.6.14|hof/ 0.6.8 0.6.9-' || true)
}
