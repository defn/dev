{
  inputs = {
    cue.url = github:defn/dev/pkg-cue-0.5.0-4?dir=m/pkg/cue;
    hof.url = github:defn/dev/pkg-hof-0.6.8-beta.12-3?dir=m/pkg/hof;
    gum.url = github:defn/dev/pkg-gum-0.10.0-6?dir=m/pkg/gum;
    glow.url = github:defn/dev/pkg-glow-1.5.0-6?dir=m/pkg/glow;
  };
