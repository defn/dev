{
  inputs = {
    cue.url = github:defn/dev/m/pkg-cue-0.5.0-4?dir=pkg/cue;
    hof.url = github:defn/dev/m/pkg-hof-0.6.8-beta.12-3?dir=pkg/hof;
    gum.url = github:defn/dev/m/pkg-gum-0.10.0-6?dir=pkg/gum;
    glow.url = github:defn/dev/m/pkg-glow-1.5.0-6?dir=pkg/glow;
  };
