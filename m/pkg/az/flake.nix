{
  inputs = {
    cue.url = github:defn/dev/pkg-cue-0.7.0-1?dir=m/pkg/cue;
    gum.url = github:defn/dev/pkg-gum-0.13.0-1?dir=m/pkg/gum;
    vhs.url = github:defn/dev/pkg-vhs-0.7.1-1?dir=m/pkg/vhs;
