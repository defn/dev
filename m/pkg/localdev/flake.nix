{
  inputs = {
    ...
    gh.url = github:defn/dev/pkg-gh-2.37.0-1?dir=m/pkg/gh;
    earthly.url = github:defn/dev/pkg-earthly-0.7.20-1?dir=m/pkg/earthly;
    oras.url = github:defn/dev/pkg-oras-1.1.0-1?dir=m/pkg/oras;
    buildkite.url = github:defn/dev/pkg-buildkite-3.56.0-1?dir=m/pkg/buildkite;
