{
  inputs = {
    tilt.url = github:defn/dev/pkg-tilt-0.32.4-1?dir=m/pkg/tilt;
    ...
    earthly.url = github:defn/dev/pkg-earthly-0.7.6-1?dir=m/pkg/earthly;
    buildkite.url = github:defn/dev/pkg-buildkite-3.47.0-1?dir=m/pkg/buildkite;
