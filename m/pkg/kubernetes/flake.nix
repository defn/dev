{
  inputs = {
    ...
    k3sup.url = github:defn/dev/pkg-k3sup-0.13.4-1?dir=m/pkg/k3sup;
    k9s.url = github:defn/dev/pkg-k9s-0.30.0-1?dir=m/pkg/k9s;
    ...
    linkerd.url = github:defn/dev/pkg-linkerd-2.14.7-3?dir=m/pkg/linkerd;
