{
  inputs = {
    ...
    kustomize.url = github:defn/dev/pkg-kustomize-5.0.1-6?dir=m/pkg/kustomize;
    stern.url = github:defn/dev/pkg-stern-1.25.0-5?dir=m/pkg/stern;
    ...
    vcluster.url = github:defn/dev/pkg-vcluster-0.15.0-5?dir=m/pkg/vcluster;
    kubevirt.url = github:defn/dev/pkg-kubevirt-0.59.0-6?dir=m/pkg/kubevirt;
    velero.url = github:defn/dev/pkg-velero-1.11.0-1?dir=m/pkg/velero;
  };
