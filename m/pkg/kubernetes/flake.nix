{
  inputs = {
    ...
    argocd.url = github:defn/dev/pkg-argocd-2.7.9-1?dir=m/pkg/argocd;
    ...
    velero.url = github:defn/dev/pkg-velero-1.11.1-1?dir=m/pkg/velero;
    cilium.url = github:defn/dev/pkg-cilium-0.15.4-1?dir=m/pkg/cilium;
