{
  inputs = {
    ...
    cilium.url = github:defn/dev/pkg-cilium-0.16.2-1?dir=m/pkg/cilium;
    hubble.url = github:defn/dev/pkg-hubble-0.13.2-1?dir=m/pkg/hubble;
    tfo.url = github:defn/dev/pkg-tfo-2.2.0-5?dir=m/pkg/tfo;
    mirrord.url = github:defn/dev/pkg-mirrord-3.92.1-1?dir=m/pkg/mirrord;
    crossplane.url = github:defn/dev/pkg-crossplane-1.15.1-1?dir=m/pkg/crossplane;
