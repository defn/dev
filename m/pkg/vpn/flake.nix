{
  inputs = {
    tailscale.url = github:defn/dev/pkg-tailscale-1.56.1-3?dir=m/pkg/tailscale;
    cloudflared.url = github:defn/dev/pkg-cloudflared-2023.8.2-5?dir=m/pkg/cloudflared;
  };
