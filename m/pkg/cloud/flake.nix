{
  inputs = {
    terraform.url = github:defn/dev/pkg-terraform-1.4.6-1?dir=m/pkg/terraform;
    packer.url = github:defn/dev/pkg-packer-1.8.6-7?dir=m/pkg/packer;
    step.url = github:defn/dev/pkg-step-0.24.3-5?dir=m/pkg/step;
