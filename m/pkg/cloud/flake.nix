{
  inputs = {
    terraform.url = github:defn/dev/m/pkg-terraform-1.4.6-1?dir=pkg/terraform;
    packer.url = github:defn/dev/m/pkg-packer-1.8.6-7?dir=pkg/packer;
    step.url = github:defn/dev/m/pkg-step-0.24.3-5?dir=pkg/step;
    awscli.url = github:defn/dev/m/pkg-awscli-2.11.15-1?dir=pkg/awscli;
  };
