{
  inputs = {
    terraform.url = github:defn/dev/pkg-terraform-1.5.6-1?dir=m/pkg/terraform;
    ...
    awscli.url = github:defn/dev/pkg-awscli-2.13.14-1?dir=m/pkg/awscli;
    flyctl.url = github:defn/dev/pkg-flyctl-0.1.86-1?dir=m/pkg/flyctl;
