{
  inputs = {
    nix.url = github:defn/dev/pkg-nix-0.0.53?dir=m/pkg/nix;
    secrets.url = github:defn/dev/pkg-secrets-0.0.57?dir=m/pkg/secrets;
    utils.url = github:defn/dev/pkg-utils-0.0.53?dir=m/pkg/utils;
    ...
    jsdev.url = github:defn/dev/pkg-jsdev-0.0.61?dir=m/pkg/jsdev;
    pydev.url = github:defn/dev/pkg-pydev-0.0.124?dir=m/pkg/pydev;
    shell.url = github:defn/dev/pkg-shell-0.0.62?dir=m/pkg/shell;
  };
