{
  inputs = {
    home.url = github:defn/dev/pkg-home-0.0.134?dir=m/pkg/home;
    ...
    cloud.url = github:defn/dev/pkg-cloud-0.0.215?dir=m/pkg/cloud;
    kubernetes.url = github:defn/dev/pkg-kubernetes-0.0.206?dir=m/pkg/kubernetes;
