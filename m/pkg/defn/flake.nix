{
  inputs = {
    ...
    secrets.url = github:defn/dev/pkg-secrets-0.0.58?dir=m/pkg/secrets;
    utils.url = github:defn/dev/pkg-utils-0.0.54?dir=m/pkg/utils;
    development.url = github:defn/dev/pkg-development-0.0.79?dir=m/pkg/development;
    cloud.url = github:defn/dev/pkg-cloud-0.0.213?dir=m/pkg/cloud;
    kubernetes.url = github:defn/dev/pkg-kubernetes-0.0.201?dir=m/pkg/kubernetes;
    remotedev.url = github:defn/dev/pkg-remotedev-0.0.30?dir=m/pkg/remotedev;
    localdev.url = github:defn/dev/pkg-localdev-0.0.211?dir=m/pkg/localdev;
    godev.url = github:defn/dev/pkg-godev-0.0.123?dir=m/pkg/godev;
