    ...
    flake-utils.lib.eachDefaultSystem (system: {
      defaultPackage =
        ...
        stdenv.mkDerivation rec {
          ...
          src = pkgs.fetchurl {
            url = "https://github.com/superfly/kubebuilder/releases/download/v${version}/kubebuilder_${version}_Linux_${arch2}.tar.gz";
          ...
          installPhase = ''
            mkdir -p $out/bin
            install -m 0755 kubebuilder $out/bin/kubebuilder
          '';
